...
external.Quote = vogels.define('Quote', {
	tableName: 'Quotes',
	hashKey: 'id',
	//rangeKey: 'dateKey',
	// createdAt, updatedAt
...
external.TargetQuote = vogels.define('TargetQuote', {
...
Promise.promisifyAll(external.Quote);
Promise.promisifyAll(external.TargetQuote);
