...
function createQuoteId(quote) {
	...
	return utils.md5([quote.author.id.toString().trim(), hash].join('_'));
}
...
function normalizeQuote(data) {
	...
	data.webpage.title = data.webpage.title.substr(0, 200);
...
exports.createId = createQuoteId;
exports.createHash = createQuoteHash;
exports.normalize = normalizeQuote;
